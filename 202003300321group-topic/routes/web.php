...
Route::group(['middleware' => ['auth'], 'prefix' => '/home'], function () {
    ...
    Route::get('/sc_news', 'Sc_NewsController@index');

    Route::get('/sc_news/create', 'Sc_NewsController@create');
    Route::post('/sc_news/store', 'Sc_NewsController@store');

    Route::get('/sc_news/edit/{id}', 'Sc_NewsController@edit');
    Route::post('/sc_news/update/{id}', 'Sc_NewsController@update');

    Route::post('/sc_news/delete/{id}', 'Sc_NewsController@delete');

    //千暘最新消息
    Route::get('/', 'HomeController@index');

    Route::get('/cy_news', 'Cy_NewsController@index');

    Route::get('/cy_news/create', 'Cy_NewsController@create');
    Route::post('/cy_news/store', 'Cy_NewsController@store');

    Route::get('/cy_news/edit/{id}', 'Cy_NewsController@edit');
    Route::post('/cy_news/update/{id}', 'Cy_NewsController@update');

    Route::post('/cy_news/delete/{id}', 'Cy_NewsController@delete');
